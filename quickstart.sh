...
echo "   curl -X POST http://localhost:8000/jobs/upload -F \"file=@transactions.csv\""
echo ""
echo "2. Check job status:"
echo "   curl http://localhost:8000/jobs/{job_id}/status"
echo ""
echo "3. Get results (after completion):"
echo "   curl http://localhost:8000/jobs/{job_id}/results"
echo ""
echo "4. View logs:"
